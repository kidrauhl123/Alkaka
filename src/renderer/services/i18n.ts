...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    system: '跟随系统',
    themeColor: '深浅主题',
    'theme-name-classic-light': '浅色',
    'theme-name-classic-dark': '深色',
    chinese: '中文',
    english: 'English',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 Alkaka Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'Alkaka 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 Alkaka 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 Alkaka 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'Alkaka 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 Alkaka 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'Alkaka 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'Alkaka 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'Alkaka 服务协议',
    privacyDialogDesc: '在使用 Alkaka 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'Alkaka 服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用Alkaka',
  ...
  en: {
    ...
    'theme-name-classic-light': 'Light',
    'theme-name-classic-dark': 'Dark',
    chinese: 'Chinese',
    english: 'English',
    ...
    copied: 'Copied',
    copyrightHolder: 'Alkaka. All rights reserved.',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit Alkaka Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    coworkWorkingDirectoryHint: 'Alkaka will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for Alkaka...',
    coworkSystemPromptHint: "Optional system prompt to customize Alkaka's behavior",
    ...
    coworkModelSettingsHint:
      'Alkaka uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save Alkaka settings. Please try again.',
    ...
    coworkPermissionDescription: 'Alkaka is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'Alkaka needs your input',
    ...
    // Security scan
    alkakaGuardEnabled: 'Security Active',
    ...
    // Privacy dialog
    privacyDialogTitle: 'Alkaka Terms of Service',
    privacyDialogDesc:
      'Before using Alkaka, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'Alkaka Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to Alkaka',
