...
This guide walks through testing the entire Web Search Skill integration with Alkaka.

## Prerequisites

1. Alkaka built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with Alkaka.

**Steps:**

1. Start Alkaka in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of Alkaka launch.
...
1. Open a terminal while Alkaka is running
...
**Objective:** Verify graceful shutdown of services when Alkaka quits.

**Steps:**

1. With Alkaka running and searches completed, quit the application
...
1. Start Alkaka (ensure headless is false in config)
...
- ✅ Server auto-starts with Alkaka
