      ...
      {isBatchMode ? (
        ...
        <div className="px-3 pb-3 pt-1 flex items-center gap-1">
          <button
            ...
            className="inline-flex w-full items-center justify-start gap-2 rounded-lg px-2.5 py-2 text-sm font-medium text-secondary hover:text-foreground hover:bg-surface-raised transition-colors"
