 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/Alkaka/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\Alkaka\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/Alkaka/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`Alkaka started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
